...
UI.CustomTheme=function(){
	...
	var styles={//light
		...
		code_editor:{
			...
			autoedit_button_dx_shake:200,
			autoedit_shake_params:{
				k_shake:300,
				damping_shake:12,
				x_min_shake:0.5,
				dx_min_shake:0.5,
		...
		package_item:{
			h:96,
			padding:8,
			icon_color:L?0xffb4771f:0xffaceaea,
			...
			name_font_bold:UI.Font(UI.font_name,24,100),
			name_color:L?0xff000000:0xffe8e8e8,
			hint_font:UI.Font(UI.font_name,18,-50),
			hint_font_bold:UI.Font(UI.font_name,18,100),
